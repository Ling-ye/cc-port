...
1. Open the [CC Port v0.5.3 Public Beta](https://github.com/Ling-ye/cc-port/releases/tag/v0.5.3).
2. Download `cc-port_0.5.3_windows_x64_setup.exe`.
3. Verify its hash against `SHA256SUMS.txt` from the same Release.
4. Run the installer and follow its prompts.

The v0.5.3 installer is not code-signed. Windows SmartScreen may show an
