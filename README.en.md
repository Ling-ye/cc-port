...
[中文](README.md) · [Download for Windows](https://github.com/Ling-ye/cc-port/releases/tag/v0.5.2) · [Quick start](docs/getting-started.en.md) · [Report an issue](https://github.com/Ling-ye/cc-port/issues)
...
2. Download `cc-port_0.5.2_windows_x64_setup.exe` from the [v0.5.2 Public Beta release](https://github.com/Ling-ye/cc-port/releases/tag/v0.5.2).
...
- The v0.5.2 installer is unsigned, so Windows SmartScreen may show an unknown-publisher warning.
