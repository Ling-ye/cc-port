...
const en = {
  ...
  "resources.deleteUploaded": "Delete uploaded resource",
  "resources.downloadRegister": "Download / register locally",
  ...
  "resources.uninstallLocal": "Delete local plugin",
...
const zh: Record<I18nKey, string> = {
  ...
  "resources.deleteUploaded": "删除上传资源",
  "resources.downloadRegister": "下载/注册到本地",
  ...
  "resources.uninstallLocal": "删除本地插件",
